...
<link rel="apple-touch-icon" sizes="76x76" href="{{ url('AdminAssets/img/apple-icon.png') }}">
<link rel="icon" type="image/png" href="{{ url('AdminAssets/img/favicon.png') }}">

<title>Admin Index</title><!--     Fonts and icons     -->
<link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700,900|Roboto+Slab:400,700" />

<!-- Nucleo Icons -->
<link href="{{ url('AdminAssets/css/nucleo-icons.css') }}" rel="stylesheet" />
<link href="{{ url('AdminAssets/css/nucleo-svg.css') }}" rel="stylesheet" />
...
<!-- CSS Files -->
<link id="pagestyle" href="{{ url('AdminAssets/css/material-dashboard.css?v=3.0.4') }}" rel="stylesheet" />
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
      <img src="{{ url('AdminAssets/img/logo-ct.png') }}" class="navbar-brand-img h-100" alt="main_logo">
...
<li class="nav-item">
  <a class="nav-link text-white " href=" {{ url("admin/ViewUser") }}">
    
      <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        <i class="material-icons opacity-10">table_view</i>
      </div>
    
    <span class="nav-link-text ms-1">Usres</span>
  </a>
</li>

  
<li class="nav-item">
  <a class="nav-link text-white " href="ViewProducts">
          ...
          <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
            <li class="mb-2">
              <a class="dropdown-item border-radius-md" href="javascript:;">
                <div class="d-flex py-1">
                  <div class="my-auto">
                    <img src="{{ url('AdminAssets/img/team-2.jpg') }}" class="avatar avatar-sm  me-3 ">
                  </div>
            ...
            <li class="mb-2">
              <a class="dropdown-item border-radius-md" href="javascript:;">
                <div class="d-flex py-1">
                  <div class="my-auto">
                    <img src="{{ url('AdminAssets/img/small-logos/logo-spotify.svg') }}" class="avatar avatar-sm bg-gradient-dark  me-3 ">
                  </div>
                  <div class="d-flex flex-column justify-content-center">
                    <h6 class="text-sm font-weight-normal mb-1">
